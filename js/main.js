...
require(['jquery'], function ($) {
	...
	settingsFn.prototype = {
		...
		apply: function () {
			...
			if (that.get('logo')) {
				...
				$(".logo").html('<svg t="1658884827557" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6690" width="128" height="128"><path d="M525.8 427.6m-370 0a370 370 0 1 0 740 0 370 370 0 1 0-740 0Z" fill="#F7C83C" p-id="6691"></path><path d="M525.8 999.2c-19.5 0-35.3-15.8-35.3-35.3l-17.6-188.1c0-19.5 33.4-35.3 52.9-35.3s52.9 15.8 52.9 35.3L561 964c0 19.4-15.8 35.2-35.2 35.2z" fill="#F7C83C" p-id="6692"></path><path d="M521.8 704.6l-5.4-0.1c-19.5-0.3-35-16.4-34.7-35.8 0.3-19.3 16-34.7 35.2-34.7h4.8c118.9 0 215.7-96.7 215.7-215.7 0-118.9-96.7-215.7-215.7-215.7S306 299.3 306 418.3c0 19.5-15.8 35.3-35.3 35.3s-35.3-15.8-35.3-35.3c0-157.8 128.4-286.2 286.2-286.2S808 260.6 808 418.4c0 157.9-128.4 286.2-286.2 286.2z" fill="#FFFFFF" p-id="6693"></path><path d="M517 704.6c-110.4 0-187.5-89-187.5-216.5 0-109.5 77.3-183.1 192.3-183.1 82.1 0 125.1 59 125.1 117.2 0 30.6-11.6 59.1-32.5 80.4-16.1 16.3-45.2 35.7-92.6 35.7-19.5 0-35.3-15.8-35.3-35.3s15.8-35.3 35.3-35.3c40.3 0 54.6-24.5 54.6-45.5 0-21.5-14.3-46.7-54.6-46.7-36.6 0-121.8 11-121.8 112.6 0 87.3 47 146 117 146 19.5 0 35.3 15.8 35.3 35.3s-15.8 35.2-35.3 35.2z" fill="#FFFFFF" p-id="6694"></path></svg>');
			}
			// 夜间模式 和 壁纸
			var nightMode = {
				on: function () {
					$("body").removeClass('theme-black theme-white').addClass('theme-white');
					$(".page-search").css("background-image", "");
					$("#nightCss").removeAttr('disabled');
				},
				off: function () {
					if (that.get('wallpaper')) {
						$(".page-search").css("background-image", "url(" + that.get('wallpaper') + ")");
					} else {
						$(".page-search").css("background-image", "");
					}
	...
	var bookMarkFn = function (ele, options) {
		this.$ele = $(ele);
		this.options = {
			data: [{ "name": "精选", "url": "choice()", "icon": "icon/discover.png" }, { "name": "微博", "url": "https://www.weibo.com", "icon": "icon/weibo.png" }, { "name": "Bilibili", "url": "https://www.bilibili.com", "icon": "icon/bilibilibog.png" }, { "name": "知乎", "url": "https://www.zhihu.com", "icon": "icon/zhihu.png" }, { "name": "Gitee", "url": "https://gitee.com/", "icon": "icon/gitee.png" }, { "name": "开源中国", "url": "https://www.oschina.net/", "icon": "icon/oschina.png" }, { "name": "GitHub", "url": "https://github.com", "icon": "icon/github.png" }, { "name": "少数派", "url": "https://sspai.com", "icon": "icon/sspai.png" }, { "name": "热榜", "url": "https://tophub.today", "icon": "icon/tophub.png" }, { "name": "摸鱼", "url": "moyu", "icon": "icon/moyu.gif" }],
		};
	...
	$(".shortcut3").click(function (evt) {
		if (evt.target.nodeName === "LI") {
			...
			var data = {
				...
				视频: "https://search.bilibili.com/all?keyword=%s",
				豆瓣: "https://douban.com/search/?query=%s",
				新闻: "http://toutiao.com/search/?&keyword=%s",
				图片: "https://baidu.com/sf/vsearch?pd=image_content&word=%s&tn=vsearch&atn=page",
				购物: "https://s.taobao.com/search?q=%s",
				微博: "https://weibo.cn/search?containerid=100103type=1&q=%s",
				音乐: "http://music.migu.cn/v3/search?keyword=%s",
				知乎: "https://www.zhihu.com/search?q=%s",
				小说: "https://qidian.com/search?kw=%s",
				旅游: "https://taobao.com/trip/rx-search/list/index.html?&keyword=%s",
				地图: "https://amap.com/search/mapview/keywords=%s",
				电视剧: "http://iqiyi.com/search.html?key=%s",
				股票: "https://emwap.eastmoney.com/info/search/index?t=14&k=%s",
				汽车: "https://sou.autohome.com.cn/zonghe?q=%s"
			}
			if (data[text]) {
				//location.href = data[text].replace("%s", $(".search-input").val());
				window.open(data[text].replace("%s", $(".search-input").val()));
			}
		}
	});
		...
		setTimeout(function () { // 异步执行 兼容QQ浏览器
			if (settings.get('engines') === "via") {
				...
				location.href = {
					...
					sm: "https://www.sm.cn/s?q=%s",
					haosou: "https://www.so.com/s?q=%s",
					sogou: "https://www.sogou.com/web/searchList.jsp?keyword=%s",
	...
	//精选页面
		...
		// 构建HTML
		var data = { "常用": [{ "hl": "百度", "shl": "百度一下你就知道", "img": "baidu", "url": "baidu.com" }, { "hl": "腾讯", "shl": "手机腾讯网", "img": "qq", "url": "qq.com" }, { "hl": "新浪", "shl": "联通世界的超级平台", "img": "sina", "url": "sina.cn" }, { "hl": "谷歌", "shl": "最大的搜索引擎", "img": "google", "url": "www.google.com.hk" }, { "hl": "搜狐", "shl": "懂手机更懂你", "img": "sohu", "url": "sohu.com" }, { "hl": "网易", "shl": "各有态度", "img": "netease", "url": "163.com" }, { "hl": "起点中文网", "shl": "精彩小说大全", "img": "qidian", "url": "qidian.com" }, { "hl": "淘宝", "shl": "淘我喜欢", "img": "taobao", "url": "taobao.com" }, { "hl": "京东", "shl": "多好快省品质生活", "img": "jd", "url": "jd.com" }, { "hl": "百度贴吧", "shl": "最大的中文社区", "img": "tieba", "url": "tieba.baidu.com" }, { "hl": "12306", "shl": "你离世界只差一张票", "img": "12306", "url": "www.12306.cn/mormhweb/" }, { "hl": "飞猪", "shl": "阿里旅行再升级", "img": "flypig", "url": "www.fliggy.com" }, { "hl": "查快递", "shl": "快递查询", "img": "kuaidi", "url": "yz.m.sm.cn/s?from=wy279236&q=%E6%9F%A5%E5%BF%AB%E9%80%92" }, { "hl": "优酷", "shl": "热门视频全面覆盖", "img": "youku", "url": "www.youku.com" }, { "hl": "爱奇艺", "shl": "中国领先的视频门户", "img": "iqiyi", "url": "iqiyi.com" }, { "hl": "斗鱼", "shl": "每个人的直播平台", "img": "douyu", "url": "douyu.com" }, { "hl": "虎牙", "shl": "中国领先的互动直播平台", "img": "huya", "url": "huya.com" }, { "hl": "美团", "shl": "吃喝玩乐全都有", "img": "meituan", "url": "i.meituan.com" }, { "hl": "小米", "shl": "小米官网", "img": "xiaomi", "url": "mi.com" }, { "hl": "58同城", "shl": "让生活更简单", "img": "tongcheng", "url": "58.com" }, { "hl": "九游", "shl": "发现更多好游戏", "img": "game_9", "url": "a.9game.cn" }, { "hl": "虎扑", "shl": "最篮球的世界", "img": "hupu", "url": "hupu.com" }], "科技": [{ "hl": "知乎", "shl": "知识分享社区", "img": "zhihu", "url": "www.zhihu.com" }, { "hl": "36kr", "shl": "互联网创业资讯", "img": "kr36", "url": "36kr.com" }, { "hl": "少数派", "shl": "高质量应用推荐", "img": "sspai", "url": "sspai.com" }, { "hl": "爱范儿", "shl": "泛科技媒体", "img": "ifanr", "url": "www.ifanr.com" }, { "hl": "ZEALER", "shl": "电子产品评测网站", "img": "zealer", "url": "zealer.com" }, { "hl": "瘾科技", "shl": "科技新闻和测评", "img": "engadget", "url": "cn.engadget.com" }, { "hl": "虎嗅网", "shl": "科技媒体", "img": "huxiu", "url": "huxiu.com" }, { "hl": "品玩", "shl": "有品好玩的科技", "img": "pingwest", "url": "www.pingwest.com" }, { "hl": "简书", "shl": "优质原创的内容社区", "img": "jianshu", "url": "jianshu.com" }, { "hl": "V2EX", "shl": "关于分享和探索的地方", "img": "v2ex", "url": "www.v2ex.com" }], "生活": [{ "hl": "豆瓣", "shl": "一个神奇的社区", "img": "douban", "url": "douban.com" }, { "hl": "轻芒杂志", "shl": "生活兴趣杂志", "img": "qingmang", "url": "qingmang.me/magazines/" }, { "hl": "ONE", "shl": "韩寒监制", "img": "one", "url": "wufazhuce.com" }, { "hl": "蚂蜂窝", "shl": "旅游攻略社区", "img": "mafengwo", "url": "mafengwo.cn" }, { "hl": "小红书", "shl": "可以买到国外的好东西", "img": "xiaohongshu", "url": "www.xiaohongshu.com" }, { "hl": "什么值得买", "shl": "应该能省点钱吧", "img": "smzdm", "url": "smzdm.com" }, { "hl": "淘票票", "shl": "不看书，就看几场电影吧", "img": "taopiaopiao", "url": "dianying.taobao.com" }, { "hl": "下厨房", "shl": "是男人就学做几道菜", "img": "xiachufang", "url": "xiachufang.com" }, { "hl": "ENJOY", "shl": "高端美食团购", "img": "enjoy", "url": "enjoy.ricebook.com" }], "工具": [{ "hl": "iconfont", "shl": "阿里巴巴矢量图标库", "img": "iconfont", "url": "iconfont.cn" }, { "hl": "创客贴", "shl": "平面设计作图神器", "img": "chuangkit", "url": "www.chuangkit.com" }, { "hl": "豌豆荚设计", "shl": "发现最优美的应用", "img": "wandoujia", "url": "wandoujia.com/award" }, { "hl": "喜马拉雅听", "shl": "音频分享平台", "img": "ximalaya", "url": "ximalaya.com" }, { "hl": "第2课堂", "shl": "守护全国2亿青少年健康成长", "img": "2-class", "url": "2-class.com" }, { "hl": "Mozilla", "shl": "学习web开发的最佳实践", "img": "mozilla", "url": "developer.mozilla.org/zh-CN" }, { "hl": "网易公开课", "shl": "人chou就要多学习", "img": "netease_edu_study", "url": "open.163.com" }, { "hl": "石墨文档", "shl": "可多人实时协作的云端文档", "img": "sm", "url": "shimo.im" }, { "hl": "Tool.lu", "shl": "全乎的在线工具集", "img": "tool", "url": "tool.lu" }, { "hl": "腾讯兔小巢", "shl": "免费便捷的用户意见反馈服务平台", "img": "support", "url": "support.qq.com" }] },
			html = '<div class="page-choice"><div class="page-content"><ul class="choice-ul">',
			tabHtml = '<li class="current">发现</li>',
			...
			<div class="list h3"><a class="flex-1 content" href="https://quark.sm.cn/api/rest?method=movieRec.index&format=html" style="background-image:linear-gradient(143deg, #3c446e 1%, #697994 100%)"><div class="hl relative">今日高分影荐</div><div class="video-list"><div class="video-swipe"><div class="swiper-wrapper"></div></div></div></a><a class="flex-right content back-img"><div class="hl back-hl">今日份壁纸</div><div class="back-btn">设为背景</div></a></div>
		...
		$.each(data, function (i, n) {
			...
			for (var i = 0, l = n.length; i < l; i++) {
				contentHtml += '<a href="http://' + n[i].url + '" target="_blank"><div><img src="img/choice/' + n[i].img + '.png" /><p>' + n[i].hl + '</p><p>' + n[i].shl + '</p></div></a>';
			}
			contentHtml += '</li>';
		});
		...
		$(".page-choice").on("transitionend", function (evt) {
			...
			$.ajax({
				...
				dataType: "json",
				success: function (res) {
					var url = res.imgurl.replace('1920x1080', '1080x1920');
	...
	$('#app').on('mousedown',function(e){
	    ...
	    if(key==3){//1：代表左键；2：代表中键；3：代表右键
	        ...
	        var x=e.clientX;
	        var y=e.clientY;
			$('#app').append(`	<div class="menu">
									<ul>
										<li><a id="admxn" href="javascript:;" class="menu_a">设置</a></li>
										<li><a href="https://github.com/7133017/admxn" class="menu_a" target="_blank">GitHub</a></li>
										<li><a href="https://github.com/liumingye/quarkHomePage" class="menu_a" target="_blank">quarkHomePage</a></li>
										<li class="li_separate"></li>
										<li><a href="javascript:;" class="menu_a">The custom</a></li>
										<li><a href="javascript:;" class="menu_a">The custom</a></li>
										<li><a href="javascript:;" class="menu_a">The custom</a></li>
									</ul>
								</div>
